...
{
    void* bp;
    void* best_fit = NULL; // 가장 적합한 블록의 주소값 저장할 포인터
    size_t min_diff = (size_t)-1; // 가장 작은 두 블록 크기의 차이를 저장함
 ...
 * This function is not called in the submission version.
 */
int mm_check(void) {
    char* bp;
